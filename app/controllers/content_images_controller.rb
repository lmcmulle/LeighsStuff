...
#        format.html { redirect_to(@content_image, :notice => 'ContentImage was successfully created.') }
...
#        format.html { redirect_to(@content_image, :notice => 'ContentImage was successfully updated.') }
#        format.xml  { head :ok }
#      else
